        ...
        <div className="space-y-6 text-[15px] leading-relaxed text-muted mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            ...
            <div className="p-6 bg-surface border border-border rounded-xl shadow-sm">
              ...
              <p className="text-sm">Se realizaron búsquedas en EBSCOhost (Psychology &amp; Behavioral Sciences Collection y bases complementarias, 347 resultados). No se accedió a Scopus de forma independiente. Las cadenas de búsqueda para búsquedas complementarias fueron preparadas y están disponibles para futuras iteraciones.</p>
            </div>
