    ...
    <div className="mx-auto max-w-3xl space-y-8">
      ...
      <Section title="La magnitud de la pérdida">
        <p>
          ...
          permite recuperar hasta 0,5 años. La brecha restante, si no se aborda activamente, tiende a
        ...
        <p>
          ...
          documentaron una caída del 7% en el rendimiento académico en las zonas más afectadas. Datos
          ...
          oportuna, las consecuencias pueden extenderse a lo largo de toda la trayectoria de vida.
        </p>
        <p>
      ...
      <Section title="Adaptación curricular profunda">
        ...
        <p>
          ...
          desplazar los contenidos disciplinares.
        </p>
        <p>
          El Pilar 3 del Marco Integral de Seguridad Escolar (CSSF) aboga por incorporar la educación
          sobre reducción del riesgo de desastres en el currículo formal y no formal. La experiencia
