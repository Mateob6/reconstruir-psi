      ...
      <div className="grid gap-12 lg:grid-cols-[1fr_400px] lg:items-start">
        ...
        <section className="space-y-5">
          ...
          <div className="pt-4 space-y-4">
            <p className="text-[15px] leading-relaxed text-[var(--muted)]">
              ...
              Reúne 129 fuentes verificadas y las organiza por contexto y por fase temporal.
            </p>
            <p className="text-[15px] leading-relaxed text-[var(--muted)]">
        ...
        >
          ...
          <div className="flex flex-wrap gap-2 mb-6">
            {["7 secciones", "128 referencias", "Guías descargables", "Por nivel educativo"].map((badge) => (
              <span
                key={badge}
                className="rounded-full bg-[var(--surface-raised)] border border-[var(--border)] px-3 py-1 text-xs font-medium text-[var(--muted)]"
              >
                {badge}
              </span>
            ))}
